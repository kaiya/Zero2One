...
- (IBAction)saveBtnClicked:(UIBarButtonItem *)sender {
    ...
    NSURL *url = [NSURL URLWithString:@"http://www.azfs.com.cn/Login/changeName.php"];
    NSString *post = [[NSString alloc]initWithFormat:@"username=%@&name=%@",[UserDefault stringForKey:@"username"],_nameTextField.text ];
    ...
    [NSURLConnection sendAsynchronousRequest:req queue:myQueue completionHandler:^(NSURLResponse *response, NSData *data, NSError *connectionError) {
        ...
        if (connectionError) {
            ...
            if ([responseString isEqualToString:@"success"]) {
                ...
                [UserDefault setValue:_nameTextField.text forKey:@"name"];
